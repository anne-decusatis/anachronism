---
layout: post
title:  "Routine rapier maintenance"
date:   2025-06-08 19:30:00 -0400
categories: rapier
---
...
![Pair of brown leather boots with white background. The one on the right is slightly darker and shinier]({{site.url}}{{site.baseurl}}/images/2025-06-08/boots.jpg "Pair of brown leather boots with white background. The one on the right is slightly darker and shinier")
...
Materials:
1. Rapier or dagger with rounded or spatulated tip (spatulated means there's a wider blob on the end, it is better if you're ordering new. I heard at practice recently that putting a washer in the tip is optional for spatulated tips.)
2. The tiniest washer you can find, like a #6 or so, or a hex nut of about that size
3. Rubber safety tip/blunt (I have some now-discontinued ones from Castille - the new generation has the washer built in, nice upgrade since getting the washer in the tip is the worst part. Recently one ordered from Amazon failed at our practice within two months of being put on so I'd go with a tip not from Amazon. The ones I have look kind of like these <https://www.swordshop.ca/product/Rubber-Safety-Tip/71?cp=true&sa=false&sbp=false&q=false&category_id=6>
4. Hockey tape in a different color than the safety tip (which is usually black but some brands can be red) or blade (which is silver). I used to use electrical tape since it's easier to find and less sticky on the outside, but it also gets destroyed faster in heat and doesn't stick as well in humidity. The East Kingdom no longer permits electrical taped tips so I am going to stop using it too: <https://www.facebook.com/groups/1929015644095555/?multi_permalinks=3890740457923054>

Steps:
1. Put the washer inside the tip of the tip. It must be parallel to the flat end of the blunt. I use a chopstick. It is extremely annoying. Sometimes soaking the tip in hot water can loosen it enough to get an otherwise too-big washer in (this has never worked for me but I was told it once). I have a hex nut in place of washer in one of my tips because you can shove it in with a bolt attached and then unscrew the bolt with less likelihood of the nut twisting.
2. Put the tip on the end of the blade. If it wiggles when otherwise in place, take it off, wrap the blade tip with a single layer of tape, then put the tip on. Ensure the tip is on as deeply as it can be, and that the washer has not slipped. The blade and the washer should be perpendicular to each other. ![Dagger with black rubber tip, layer of rainbow tape under tip only]({{site.url}}{{site.baseurl}}/images/2025-06-08/dagger1.jpg "Dagger with black rubber tip, layer of rainbow tape under tip only")
3. Wrap tape around the tip, working from the tip of the tip, down over the opening where the tip meets the blade, down over the blade. Each new wrap of tape should cover about half of the previous wrap. Do not cover the top of the tip, there should be a rubber circle with tape around the edge. This is in the rules so we can more easily check for cracks or blow-through from the blade. 
![Dagger tip with black rubber tip, wrapped in rainbow tape, first wrap]({{site.url}}{{site.baseurl}}/images/2025-06-08/dagger2.jpg "Dagger tip with black rubber tip, wrapped in rainbow tape, first wrap")
4. When you reach 2-4" of sword wrapped beneath the bottom of the tip, change the angle of the wrap overlap to start wrapping back up towards the tip again. When you reach the starting point, cut the tape. You are done! Tug the tip gently to ensure it does not wiggle. 
![Dagger tip with black rubber tip, wrapped in rainbow tape, second wrap]({{site.url}}{{site.baseurl}}/images/2025-06-08/dagger3.jpg "Dagger tip with black rubber tip, wrapped in rainbow tape, second wrap")
...
![Taped rapier and katana tips, on a white background. The tape is battered and the edge of the katana blade is visible through it.]({{site.url}}{{site.baseurl}}/images/2025-06-08/tape.jpg "Taped rapier and katana tips, on a white background. The tape is battered and the edge of the katana blade is visible through it.")
...
![Rounded edge of katana tsuba with lots of nicks in it]({{site.url}}{{site.baseurl}}/images/2025-06-08/tsuba.jpg "Rounded edge of katana tsuba with lots of nicks in it")
...
![Katana tip wrapped in rainbow hockey tape]({{site.url}}{{site.baseurl}}/images/2025-06-08/katana.jpg "Katana tip wrapped in rainbow hockey tape")

## One last pic for the sickos (affectionate)

![Big blob of old tape, hand for scale]({{site.url}}{{site.baseurl}}/images/2025-06-08/blob.jpg "Big blob of old tape, hand for scale")
